...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		// desktop: "assets/images/DesktopWallpaper/user_d1.avif",
		desktop: [
			"assets/images/DesktopWallpaper/user_d1.avif",
			"assets/images/DesktopWallpaper/user_d2.avif",
			"assets/images/DesktopWallpaper/user_d3.avif",
			"assets/images/DesktopWallpaper/user_d4.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/user_m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/user_m1.avif",
			"assets/images/MobileWallpaper/user_m2.avif",
			"assets/images/MobileWallpaper/user_m3.avif",
			"assets/images/MobileWallpaper/user_m4.avif",
		],
		// 背景视频播放地址
		// 支持单个视频路径（字符串）或多个视频循环（数组）
		// 支持远程视频URL，本地视频请放在 public/assets/videos/ 目录下
		// playerUrl: "/assets/videos/firefly.mp4",
		playerUrl: "/assets/videos/deichuu.mp4",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			switchable: true,
			// 主页横幅主标题
			title: "✨ Super Lovely's Blog ✨",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
				"We are all in the gutter, but some of us are looking at the stars.",
				"I am distinct from all the world.",
				"In the middle of winter, I at last learned that there was in me an invincible summer.",
