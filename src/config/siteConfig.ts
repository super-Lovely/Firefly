...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "Super Lovely BLOG!",

	// 站点副标题
	subtitle: "A blog about Astro, ACGN and more.",
	...
	// 站点描述
	description:
		"This blog based the firefly project, which is a static blog framework based on Astro and TailwindCSS.",
